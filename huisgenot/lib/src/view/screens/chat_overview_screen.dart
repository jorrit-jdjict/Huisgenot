                  ...
                  builder: (context, snapshot1) {
                    if (snapshot1.connectionState == ConnectionState.waiting) {
                      ...
                      for (var user in snapshot1.data!) {
                        if (user.id == "7sZXYmgI4KM5UoItkr1l") {
                          // TODO: Replace user ID with global variable or something
                                        ...
                                        return Container(
                                          ...
                                          decoration: const BoxDecoration(
                                            border: Border(
                                              bottom: BorderSide(
                                                color: Color(
                                                    0x54F7F7F7), // Change the color to your preference
                                                width:
                                                    0.5, // Change the width as needed
                                              ),
                                            ),
                                          ),
                                          child: ListTile(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const HouseMapScreen(
                title: 'test',
              ),
            ),
          );
